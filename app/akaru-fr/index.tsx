  ...
  useEffect(() => {
    ...
    mm.add('(min-width: 1440px)', () => {
      ...
      const desktop = gsap.context(() => {
        ...
        tl.fromTo(mediaContainers[1], { xPercent: -60, scale: 1.0, transformOrigin: '100% 100% 0px' }, { xPercent: -101, scale: 0.8 }, '<')
        ...
        tl.fromTo(mediaContainers[2],{ xPercent: -60, scale: 1.0, transformOrigin: '100% 100% 0px' },{ xPercent: -101, scale: 0.8 },'<')
        ...
        tl.fromTo(mediaContainers[3], { xPercent: -60, scale: 1.0, transformOrigin: '100% 100% 0px' }, { xPercent: -101, scale: 0.8 }, '<')
        ...
        tl.fromTo(mediaContainers[4], { xPercent: -60, scale: 1.0, transformOrigin: '100% 100% 0px' }, { xPercent: -101, scale: 0.8 }, '<')
